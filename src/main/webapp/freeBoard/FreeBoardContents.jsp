            ...
            <div class="container">
                ...
                <form action="/update.freeBoard" method="post">
                    ...
                    <div class="row">
                        ...
                        <div contenteditable="false" id="content" placeholder="내용을 입력해주세요">${list.content}</div>
                        ...
                        <c:forEach var="i" items="${replyResult}">
                            <form action="/update.reply" method="post">
                                <div id="replyForm">
                                    ...
                                    <input type="text" class="reply_text" name="replyContent" value="${i.contents}"
                                        readonly>
                                    <div class="reply_info">
                                        ...
                                        <c:choose>
                                            <c:when test="${sessionScope.loggedID eq i.writer}">
                                                <input type="button" class="noBorderBtn replyUpdate" value="댓글수정">
                                                <input type="button" class="noBorderBtn replyDel" value="댓글삭제"
                                                    seq="${i.seq}">
                ...
                <div class="row ReplyInputRow">
                    ...
                    <div class="col ReplyInputCol">
                        ...
                        <input type="text" name="replyContent" id="replyContent" placeholder="댓글을 입력해주세요"> <input
                            type=button class="replyInsertBtn" value="등록" id="replyInsert">
                    </div>
                    <hr style="width: 100%;">
                </div>
