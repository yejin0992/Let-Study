                            ...
                            <div class="d-flex justify-content-center row" id="searchDiv">
                                <div class="col-2 p-0">
                                    <select class="form-select text-center" id="select"
                                        aria-label="Default select example" name="optionValue">
                            ...
                            <c:choose>
                                <c:when test="${i eq '<<'}">
                                    <li class="page-item"><a class="page-link"
                                            href="/contentList.freeBoard?cpage=${start}">${i}</a></li>
                                </c:when>
                                <c:when test="${i eq '<'}">
                                    <li class="page-item"><a class="page-link"
                                            href="/contentList.freeBoard?cpage=${cpage - 1}">${i}</a></li>
                                </c:when>
                                <c:when test="${i eq '>'}">
                                    <li class="page-item"><a class="page-link"
                                            href="/contentList.freeBoard?cpage=${cpage + 1}">${i}</a></li>
                                ...
                                <c:when test="${i eq '>>'}">
                                    <li class="page-item"><a class="page-link"
                                            href="/contentList.freeBoard?cpage=${end}">${i}</a></li>
                                </c:when>
                                <c:otherwise>
                                    <li class="page-item">
                                        <a class="page-link ${i == cpage ? 'current-page' : ''}"
                                            href="/contentList.freeBoard?cpage=${i}" ${i==cpage ? "disabled" : "" }
